...
inline constexpr std::string_view kClipboardAtomName = "CLIPBOARD";

class X11Provider : public LinuxClipboardProvider<X11Provider> {
public:
    X11Provider()
        : m_xcb(std::make_shared<xcb::Xcb>()),
          m_clipboard_atom(m_xcb->create_atom(kClipboardAtomName)),
