...
struct QuickSortNiebloid final {
    static constexpr auto kAlgorithmName = niebloid_tools::get_algorithm_name<QuickSortNiebloid>();

    template <StringIterator Iterator, class Comparator = std::ranges::less>
