...
public:
    ...
    Node<T>* root{};
protected:
    static void LeftRotate(Node<T>* node) noexcept {
        /**
         *  parent_parent
         *       |
         *     parent
    ...
    static void RightRotate(Node<T>* node) noexcept {
        /**
         *    parent_parent
         *         |
         *       parent
...
protected:
    ...
    void Rebalance(Node<T>* current_node, Node<T>* new_red_son) noexcept {
        ...
        Node<T>* current_node_bruder = AnotherChild(parent_node, current_node);
        ...
        if (current_node->left == new_red_son) {
            if (parent_node->left == current_node) {
                ...
                RightRotate(new_red_son);
                LeftRotate(new_red_son);
                parent_node->color = Color::RED;
